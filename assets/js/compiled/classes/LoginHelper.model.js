...
var LoginHelper = /*#__PURE__*/function (_ConnectionHelper) {
  _inherits(LoginHelper, _ConnectionHelper);
  var _super = _createSuper(LoginHelper);
  function LoginHelper() {
    var _this;
    _classCallCheck(this, LoginHelper);
    _this = _super.call(this);
    _this._passwordInputElt = document.getElementById('user-password');
    _this._inputElts = [_this._emailInputElt, _this._passwordInputElt];
    _this._isPasswordValid = false;
    return _this;
  }
  _createClass(LoginHelper, [{
    key: "isPasswordValid",
    get: function get() {
      return this._isPasswordValid;
    },
    set: function set(_boolean) {
      this._isPasswordValid = _boolean;
    }
  }, {
    ...
    value: function addSubmitButtonListener() {
      ...
      this._form.addEventListener('submit', function (e) {
        if (!_this2.isEmailValid || !_this2.isPasswordValid) {
          e.preventDefault();
        }
      });
    }
