...
var RegisteringHelper = /*#__PURE__*/function (_ConnectionHelper) {
  _inherits(RegisteringHelper, _ConnectionHelper);
  var _super = _createSuper(RegisteringHelper);
  function RegisteringHelper() {
    var _this;
    _classCallCheck(this, RegisteringHelper);
    ...
    _this._inputElts = [_this._emailInputElt, _this._confirmationPasswordInputElt, _this._passwordInputElt];
    _this._arePasswordIdentical = false;
    _this._isConfirmationPasswordValid = false;
    _this._isPasswordValid = false;
    return _this;
  }
  _createClass(RegisteringHelper, [{
    ...
    value: function addSubmitButtonListener() {
      ...
      this._form.addEventListener('submit', function (e) {
        if (!_this2.isEmailValid || !_this2.isPasswordValid || !_this2.isConfirmationPasswordValid || !_this2.arePasswordIdentical) {
          e.preventDefault();
        }
      });
    }
    ...
    value: function isBlurredInputValid(inputElt, isInputEmpty) {
      var inputType = inputElt.type;
